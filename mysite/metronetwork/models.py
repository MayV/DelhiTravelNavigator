...
class Metro(models.Model):
    ...
    stations = ListCharField(base_field=models.CharField(max_length=100), size=100, max_length=1000*101)
    distance = ListTextField(base_field=models.IntegerField(), size=100)
